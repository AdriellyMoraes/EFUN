...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            #tela{
                background: url(IMG/it.jpg) no-repeat center center fixed;
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top"><i class="fa fa-home"></i> E-FUN </br> </a>          
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <h1 class="brand-heading">500</h1>
                            <h3>Internal Error Server</h3>
                             <br><button type="submit" class="btn btn-primary" id="tom" onclick="history.go(-1)">Retornar</button></br>
                            <p class="intro-text"> 
                        </div>
                    </div>
                </div> 
